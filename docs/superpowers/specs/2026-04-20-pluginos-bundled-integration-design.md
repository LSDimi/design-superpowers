...
> **Date:** 2026-04-20
> **Status:** Superseded by `2026-05-07-pluginos-marketplace-integration-design.md` — PluginOS is now a first-class Claude Code plugin (v0.4.3 with `marketplace.json` at the repo root), so vendoring is no longer the right shape.
> **Depends on:** `2026-04-13-pluginos-integration-and-ds-decoupling.md`
