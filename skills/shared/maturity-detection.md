...
|-------|-----------|----------|------------|---------|----------------|-------------|
| L0 | Full freedom; no constraints (refresh requests hand off to first-direction exploration — nothing exists to refresh) | Scaffold from scratch | Not available (no DS to manage) | Use DESIGN.md or freeform | Visual quality + UX only | Full extraction; generate DESIGN.md |
